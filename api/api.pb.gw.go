...
func request_Ping_Login_0(ctx context.Context, marshaler runtime.Marshaler, client PingClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Ping_Login_0(ctx context.Context, marshaler runtime.Marshaler, server PingServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq LoginRequest
	var metadata runtime.ServerMetadata
...
func RegisterPingHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PingServer) error {
	...
	mux.Handle("POST", pattern_Ping_Login_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Ping_Login_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Ping_Login_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPingHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PingClient) error {
	...
	mux.Handle("POST", pattern_Ping_Login_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Ping_Login_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Ping_Login_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"login"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Ping_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"sayhello"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Ping_Login_0 = runtime.ForwardResponseMessage
